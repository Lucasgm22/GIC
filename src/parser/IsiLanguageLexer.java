...
public class IsiLanguageLexer extends Lexer {
	...
	public static final int
		...
		SUB=17, OPREL=18, ID=19, VIRG=20, PF=21, AP=22, FP=23, BLANK=24;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "NUMBER", "NUMBERDEC", "TEXT", "ATTR", "SUM", "SUB", 
			"OPREL", "ID", "VIRG", "PF", "AP", "FP", "BLANK"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NUMBER", "NUMBERDEC", "TEXT", "ATTR", "SUM", "SUB", "OPREL", "ID", "VIRG", 
			"PF", "AP", "FP", "BLANK"
		};
	}
